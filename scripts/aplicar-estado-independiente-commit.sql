-- Aplicación REAL: estado independiente del ejecutor.
-- UNA sesión: BEGIN → migración → COMMIT.
-- No usar salvo dry-run fresco 68/68 + OK explícito.
...
-- === supabase/migrations/20260901220000_estado_independiente_ejecutor.sql ===
